var innovate_config = {
    maps:[
    {
        ...
        ,'header':'Changes in absolute sea level along U.S. coasts, 1993-2014'
        ...
        ,'legend':{
            ...
            "url": './scripts/innovate/images/87-3.png'
           
        }
        , 'baseMap': ['hybrid', 'gray']
        , 'layers': ['ROE_SeaLevelAbsolute2015']
        ...
        ,'header':'Annual precipitation anomalies in the U.S. by region, 1901-2014'
        ...
        ,'header':'Annual temperature anomalies in the U.S. by region, 1901-2014'
        ,'startResolution':3//gets the resolution from serverResolutions using the startResolution as index
        ,'endResolution':5//number of zoom levels you want, 21 is max and must be greater than startResolution
        ,'projection' : 'EPSG:3857'
        ,'maxExtent' : [-19146952.4164,1979106.4997,-7402746.1378,11935768.7022]
        ...
        ,'header':'Changes in relative sea level along U.S. coasts, 1960-2014'
        ,'startResolution':2
        ,'endResolution':14
        ,'projection' : 'EPSG:3857'
        ...
        ,'dataSource':'U.S. EPA, 2007d'
        ,'legend':{
             //"url":'http://app2.erg.com/ROE/images/87-1.png'
            "url": './scripts/innovate/images/87-1.png'
            //,"layers":{"0":"Mean relative sea level change (mm per year):"}
            //,"cols" : 4//manual override on no of columns to dispplay in legend because the average thing didn't work out for this map
        }
        , 'baseMap': ['hybrid', 'gray']
        , 'layers': ['ROE_SeaLevelRelative2015']
    ...
    ,{
        ...
        ,'legend':{
            "url": 'ROE_LongIslandHypoxia2015/MapServer/legend'
            ,"layers":{"1":"Dissolved oxygen:"}
            //,"discard":{"0":"Y"}
        }
        ,'baseMap' : ['bing','arcGisCanvasWorldLightGrayBase']
        , 'layers': ['ROE_LongIslandHypoxia2015']
    ...
    ,{
        ...
        ,'baseMap' : ['bing','arcGisCanvasWorldLightGrayBase']
        , 'layers': ['ROE_WetNitrateDeposition1989_1991', 'ROE_WetNitrateDeposition2014', 'ROE_StateBoundaries']
        ...
        ,'baseMap' : ['bing','arcGisCanvasWorldLightGrayBase']
        , 'layers': ['ROE_WetSulfateDeposition1989_1991', 'ROE_WetSulfateDeposition2014', 'ROE_StateBoundaries']
        ...
        ,'dataSource':'U.S. EPA, 2012'
        ,'legend':{
            "url": 'http://app2.erg.com/ROE/images/legend/41-2.png'
            //,"discard":{"1":"Y"}
        }
        ,'baseMap' : ['hybrid','gray']
        , 'layers': ['ROE_GulfofMexicoHypoxia2014']
        ...
        ,'dataSource':'U.S. EPA, 2007d'
        ,'legend':{
             "url":'http://app2.erg.com/ROE/legend/87-1.png'
