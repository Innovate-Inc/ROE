          ...
          function (
            ...
            domConstruct, BasemapToggle, Scalebar, dom, number, on, parser, arrayUtils, Color, string, domStyle, HorizontalSlider, popup
              ...
              function showFeature(feature, evt) {
                  ...
                  var stationName = $.trim(attr.Station_Na + ", " + state);
                  ...
                  content = "<div>Relative sea level change, 1960-2015:</div>";
                  if (increase === "Rising") {
                      sign = "+";
                  }
                  content += "<div>" + sign + attr.Total_inch.toFixed(2) + " inches</div>";
                  var css = (increase === "Rising") ? "bottom" : "top";
                  content += '<table border="0"><tr><td><img src="' + imgURL + '" ></td><td style="vertical-align:' + 'middle' + '; padding-bottom:5px;">' + increase + '</td></tr></table>';
